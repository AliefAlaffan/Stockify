<x-app-layout>
    ...
    <div class="flex items-center justify-between mb-5">
        ...
        <div class="flex items-center gap-2">
            ...
            <button type="button" data-modal-target="modal-import-supplier" data-modal-toggle="modal-import-supplier"
                class="flex items-center gap-2 px-4 py-2.5 text-sm font-medium text-ink-soft bg-canvas-alt rounded-xl hover:bg-gray-200 transition-colors">
   ...
   <!-- Modal Konfirmasi Hapus -->
    ...
    <div id="modal-import-supplier" tabindex="-1" aria-hidden="true" class="hidden fixed top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full flex items-center justify-center bg-ink/20 modal-backdrop">
        <div class="modal-panel relative w-full max-w-md">
            <div class="relative bg-white rounded-2xl shadow-xl">
                <div class="flex items-center justify-between p-5 border-b border-gray-100">
                    <h3 class="font-display text-lg font-semibold text-ink">Import Supplier</h3>
                    <button type="button" data-modal-hide="modal-import-supplier" class="icon-btn text-steel hover:bg-canvas-alt">
                        <svg class="w-4 h-4" fill="none" viewBox="0 0 14 14"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/></svg>
                    </button>
                </div>
                ...
                <div class="p-5 space-y-4">
                    <div class="flex items-start gap-2.5 p-3 bg-canvas-alt/60 rounded-xl">
                        ...
                        <p class="text-xs text-steel leading-relaxed">
                            Supplier dengan nama yang sudah ada akan <strong>diperbarui</strong>, nama baru akan <strong>ditambahkan</strong>.
                        </p>
                    </div>

                    <a href="{{ route('suppliers.import.template') }}" class="flex items-center gap-2 text-sm font-medium text-brand-dark hover:underline">
                        <svg class="w-4 h-4" fill="none" viewBox="0 0 20 20"><path stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" d="M10 3v10m0 0l-3.5-3.5M10 13l3.5-3.5M4 15v1a2 2 0 002 2h8a2 2 0 002-2v-1"/></svg>
                    ...
                    <form action="{{ route('suppliers.import') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="flex items-center justify-end gap-2 pt-4 mt-4 border-t border-gray-100">
                            <button type="button" data-modal-hide="modal-import-supplier" class="px-4 py-2 text-sm font-medium text-ink-soft bg-canvas-alt rounded-xl hover:bg-gray-200 transition-colors">Batal</button>
