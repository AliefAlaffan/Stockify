<x-app-layout>
    <x-slot name="header">Transaksi Barang Masuk</x-slot>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        <div class="flex items-center justify-between p-4 border-b border-gray-200">
            <h2 class="text-lg font-semibold text-gray-800">Riwayat Barang Masuk</h2>
            <a href="{{ route('stock-transactions.in.create') }}"
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left text-gray-600">
                ...
                <tbody>
                        ...
                        <tr class="bg-white border-b hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4">
                                ...
                                @elseif ($trx->status === 'Diterima')
                                    <span class="px-2.5 py-1 text-xs font-medium text-green-800 bg-green-100 rounded-full">Diterima</span>
                                @else
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-8 text-center text-gray-400">Belum ada transaksi barang masuk</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
