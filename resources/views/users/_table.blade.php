                    ...
                    <tr class="hover:bg-canvas-alt/40 transition-colors">
                        ...
                        <td class="px-6 py-3.5 text-right">
                            ...
                            @if ($user->role === 'Admin' && !$isSelf)
                                <span class="icon-btn text-steel-light cursor-not-allowed inline-flex" title="Akun Admin lain hanya bisa dikelola oleh pemiliknya sendiri">
                            ...
                            @elseif ($user->role === 'Admin' && $isSelf)
                                <div class="inline-flex items-center gap-1">
                                    ...
                                    @if ($adminCount > 1)
                                        <button type="button"
                                            data-modal-target="modal-delete-own-admin" data-modal-toggle="modal-delete-own-admin"
                                            class="icon-btn text-rust hover:bg-rust/10" title="Hapus akun saya">
                                    ...
                                    @else
                                        <span class="icon-btn text-steel-light cursor-not-allowed" title="Kamu Admin terakhir, tidak bisa dihapus">
                            ...
                            @else
                                <div class="inline-flex items-center gap-1">
                                    ...
                                    <button type="button"
                                        data-modal-target="modal-delete-user" data-modal-toggle="modal-delete-user"
