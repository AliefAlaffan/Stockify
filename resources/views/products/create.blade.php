<x-app-layout>
    ...
    <div class="flex items-center gap-3 mb-5">
        ...
        <div>
            ...
            <h1 class="font-display text-xl font-semibold text-ink">Tambah Produk Baru</h1>
        </div>
    </div>
        ...
        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            ...
            <div>
                ...
                <textarea name="description" rows="3"
                    class="bg-canvas-alt/60 border border-gray-200 text-ink text-sm rounded-xl focus:ring-2 focus:ring-brand/30 focus:border-brand block w-full p-2.5 transition-colors">{{ old('description') }}</textarea>
            </div>
            ...
            <div>
                ...
                <label id="drop-zone" class="flex flex-col items-center justify-center w-full h-36 border-2 border-dashed border-gray-200 rounded-2xl cursor-pointer bg-canvas-alt/40 hover:bg-canvas-alt/70 hover:border-brand/40 transition-colors">
                    <div id="drop-zone-content" class="flex flex-col items-center justify-center pt-5 pb-6 pointer-events-none">
                        ...
                        <p class="text-xs text-steel-light mt-0.5">PNG, JPG hingga 2MB</p>
                    </div>
            ...
            <div class="flex justify-end gap-2 pt-3 border-t border-gray-100">
                ...
                <button type="submit" class="btn-primary px-5 py-2.5 text-sm font-semibold text-white rounded-xl">Simpan Produk</button>
            </div>
        </form>
    </div>
